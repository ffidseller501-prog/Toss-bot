...
# ─────────────────────────────────────────
#  CRYPTO-SECURE RANDOM ENGINE (COIN ONLY)
# ─────────────────────────────────────────
...
def cmd_list(message):
    ...
    chosen = _rng.choice(items)
    bot.reply_to(message, f"📋 Picked from list: *{chosen}*", parse_mode="Markdown")
